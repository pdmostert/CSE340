...
-- Create relationship betweren 'invetory' and 'classification' tables
...
CREATE TABLE public.comments (
    ...
    CONSTRAINT fk_comments_inv_id FOREIGN KEY (inv_id) 
        REFERENCES public.inventory(inv_id) ON DELETE CASCADE,
    CONSTRAINT fk_comments_account_id FOREIGN KEY (account_id) 
